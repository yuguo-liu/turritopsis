...
def speedmvbacommonsubset(sid, pid, N, f, last_pb_proof, PK2s, SK2, input, decide, left_decide, receive, send, predicate=lambda i, v, t: True, logger=None):
    ...
    vaba = gevent.spawn(speedmvba, sid + 'VACS-VABA', pid, N, f, PK2s, SK2,
