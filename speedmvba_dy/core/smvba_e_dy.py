...
def recv_loop(pid, recv_func, recv_queues, C, logger):
    while True:
        ...
        # if j == 7:
        #     print(pid, "recv2", (sender, (tag, j, msg)))
        if logger != None:
...
def speedmvba(sid, pid, N, f, l, C, PK2s, SK2, ePKs, eSK, g, ty, input, decide, receive, send, localset_get, ls, predicate, logger=None):
    ...
    def views():
        ...
        while not start_wait_for_halt.is_set():
            ...
            # print(pid, ": round", r, "leader index:", leader_index)
                ...
                if ty == 's':
                    coin = thresholdcoin(sid + 'PERMUTE', pid, N, f, l, C, g, seed, ePKs, eSK, coin_recv.get,
                                         coin_bcast)
                elif ty == 'b':
                    coin = thresholdcoin_bn(sid + 'PERMUTE', pid, N, f, l, C, g, seed, ePKs, eSK, coin_recv.get,
                                            coin_bcast)
                leader_index = coin % N
