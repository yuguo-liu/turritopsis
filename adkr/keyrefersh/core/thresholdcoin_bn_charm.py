    ...
    while True:  # main receive loop
        ...
        if msg[0] == 'coin':
            ...
            if len(coinSender) == CoinyThreshold:
                coin = interpolate_g1_at_x(coinshare, 0, group.init(G1))
                coin_int = int.from_bytes(hash(group.serialize(coin)), byteorder='big')
