...
from adkr.adkr_high.adkg_adp_op.adkg_adp_high_op import Adkgadphigh
...
class ADKGADPOPNode(Adkgadphigh):
    ...
    def __init__(self, sid, id, f, N, K, bft_from_server: Callable, bft_to_client: Callable,
        ...
        Adkgadphigh.__init__(self, sid, id, N, f, K, self.g1, self.g2, self.ePKs, self.eSK, self.thpk, self.thpks, self.thsk,
