...
import phe
from adkr_hbacss.core.hbacss_avid import completesecretsharing
...
def _test_rbc1(N=4, f=1, dealer=None, seed=None):
    ...
    for i in range(N):
        ...
        t = gevent.spawn(completesecretsharing, sid, i, N, f, C_o, N, f, C_n, g1, dealer, thpks, thsks[i], input, recvs[i], sends[i], None)
        threads.append(t)
    m = 100
    leader_input.put(m)
