...
from adkr.adkr_high.core.smvba_high import MVBAhigh
...
class MVBAHIGHNode(MVBAhigh):
    ...
    def __init__(self, sid, id, f, N, K, bft_from_server: Callable, bft_to_client: Callable,
        ...
        MVBAhigh.__init__(self, sid, id, N, f, K, self.g1, self.g2, self.ePKs, self.eSK, self.thpk, self.thpks, self.thsk,
