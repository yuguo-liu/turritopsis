...
from adkr_hbacss.high_threshold_adkg.tthresholdmvba_high import Tthresholdmvba
...
class TthresholdmvbaNode(Tthresholdmvba):
    ...
    def __init__(self, sid, id, f, N, K, bft_from_server: Callable, bft_to_client: Callable,
        ...
        Tthresholdmvba.__init__(self, sid, id, N, f, K, self.g1, self.g2, self.h, self.ePKs, self.eSK, self.thpk, self.thpks, self.thsk,
