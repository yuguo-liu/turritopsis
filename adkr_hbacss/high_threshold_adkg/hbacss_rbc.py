...
def completesecretsharing(sid, pid, N_o, f_o, C_o, N_n, f_n, C_n, g, h, dealer,  ePKs, eSK,  input, output, receive, send):
    """ACSS with dcr
    ...
    if pid == dealer:
        ...
        script, script2, commits = deal(f_n, m, ciphers)
        ...
        #     outputs.append(res)
        msg = dumps((script, script2, commits, dealer))
